...
function BlogContent() {
  ...
  const canWrite = isAuthenticated && pagePermissions.canAdd;
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Link
                        ...
                        className={`text-sm ${
                          canEdit && (post.authorId?.toString() === user?.id?.toString() || 
                      ...
                      <button
                        onClick={() => {
                          if (canDelete && (post.authorId?.toString() === user?.id?.toString() || 
                                           user?.roles?.includes('admin') || 
                                           user?.roles?.includes('editor'))) {
                        ...
                        className={`text-sm ${
                          canDelete && (post.authorId?.toString() === user?.id?.toString() || 
                                       user?.roles?.includes('admin') || 
                                       user?.roles?.includes('editor'))
